<?php 
    ...
    {
        $out = "<p>
        " .$_POST['name']. " non &egrave un attore che abbia bisogno di lunghe introduzioni o premesse: la sua carriera, iniziata nel 1984 con il primo capitolo della saga di Nightmare, ha lasciato una traccia abbastanza indelebile nel mondo della settima arte.
        Sex Symbol, amato dalle folle e corteggiato da registi di un certo spessore, ".$_POST['name']." &egrave stato per anni considerato il miglior attore della sua generazione, a prescindere dai riconoscimenti canonici di Hollywood che non sono mai arrivati tra le sue mani.        
        </p>";
    }
?>
